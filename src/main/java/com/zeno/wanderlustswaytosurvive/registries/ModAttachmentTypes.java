...
public class ModAttachmentTypes {
        ...
        // 骑乘末影珍珠传送数据附件 - 存储待传送坐骑信息
        public static final Supplier<AttachmentType<MountedPearlData>> MOUNTED_PEARL = ATTACHMENT_TYPES.register(
                        "mounted_pearl",
                        () -> AttachmentType.builder(MountedPearlData::new)
                                        .serialize(MountedPearlData.CODEC)
                                        .build());
